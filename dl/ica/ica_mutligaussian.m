function Z = ica_mutligaussian(MU,SIGMA,n)
%--------------------------------------------------------------------------
% Syntax:       Z = ica_mutligaussian(MU,SIGMA);
%               Z = ica_mutligaussian(MU,SIGMA,n);
%               
...
if (d ~= d2) || (d ~= length(MU))
    % Syntax error
    error('Syntax error... Type "help ica_mutligaussian" for more info');
end
if nargin < 3
    % Default # samples
    n = 1;
